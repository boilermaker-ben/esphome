...
namespace esphome {
namespace esp32_rmt_led_strip_cwww {

static const char *const TAG = "esp32_rmt_led_strip_cwww";
...
void ESP32RMTLEDStripCWWWLightOutput::setup() {
...
void ESP32RMTLEDStripCWWWLightOutput::set_led_params(uint32_t bit0_high, uint32_t bit0_low, uint32_t bit1_high,
...
void ESP32RMTLEDStripCWWWLightOutput::write_state(light::LightState *state) {
...
light::ESPColorView ESP32RMTLEDStripCWWWLightOutput::get_view_internal(int32_t index) const {
  int32_t r = 0, g = 0, b = 0;
  ...
  uint8_t white = this->is_wrgb_ ? 0 : 3;
	...
	// Adjust the color view based on cold_white and warm_white temperatures
	auto cold_white = this->cold_white_color_temperature_;
	auto warm_white = this->warm_white_color_temperature_;

	// Map cold white to blue and warm white to red
	if (cold_white > 0) {
		b = cold_white;
		r = 0;
	}
...
void ESP32RMTLEDStripCWWWLightOutput::dump_config() {
...
float ESP32RMTLEDStripCWWWLightOutput::get_setup_priority() const { return setup_priority::HARDWARE; }
