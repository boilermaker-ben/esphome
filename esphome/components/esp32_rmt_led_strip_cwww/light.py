...
CODEOWNERS = ["@boilermaker-ben"]
DEPENDENCIES = ["esp32"]

esp32_rmt_led_strip_cwww_ns = cg.esphome_ns.namespace("esp32_rmt_led_strip_cwww")
ESP32RMTLEDStripCWWWLightOutput = esp32_rmt_led_strip_cwww_ns.class_(
    "ESP32RMTLEDStripCWWWLightOutput", light.AddressableLight
)

RGBOrder = esp32_rmt_led_strip_cwww_ns.enum("RGBOrder")
...
CONFIG_SCHEMA = cv.All(
    light.ADDRESSABLE_LIGHT_SCHEMA.extend(
        {
            cv.GenerateID(CONF_OUTPUT_ID): cv.declare_id(ESP32RMTLEDStripCWWWLightOutput),
            ...
            cv.Optional(CONF_COLD_WHITE_COLOR_TEMPERATURE, default=2700): cv.temperature,
            cv.Optional(CONF_WARM_WHITE_COLOR_TEMPERATURE, default=6500): cv.temperature,            
